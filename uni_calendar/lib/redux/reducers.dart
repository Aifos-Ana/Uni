...
AppState appReducers(AppState state, dynamic action) {
  ...
  } else if(action is SetFeupCalendar){
    return setFeupCalendar(state, action);
  } else if(action is SetSigarraEvents){
    return setSigarraEvents(state, action);
  }
  return state;
}
...
AppState setFeupCalendar(AppState state, SetFeupCalendar action){
  Logger().i('setting feup calendar: ' + action.events.length.toString());
  return state.cloneAndUpdateValue('feupcalendar', action.events);
}

AppState setSigarraEvents(AppState state, SetSigarraEvents action){
  Logger().i('setting sigarra events: ' + action.events.length.toString());
  return state.cloneAndUpdateValue('sigarraevents', action.events);
}